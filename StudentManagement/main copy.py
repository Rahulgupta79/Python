...
def UserWindow():
    ...
    def updatePanel():
        ...
        SUpdate=Button(UpdateFrame,text="Update Now",font=("Arial",18,"bold"),bd=5,command=updateData,bg="blue",fg="white")
    ...
    def searchPanel():
        ...
        def option_selected(event):
            if(SearchBo.get()!="Select"):
                ...
                # cur.execute(sql,(SearchEntry.get()))
            ...
            Sgender.get()=="" or Scaste.get()=="" or Snationality.get()=="" or Snumber.get()==""):
                ...
                if("@gmail.com" in Semail.get() and len(Snumber.get())==10):
                    try:
                        ...
                        messagebox.showwarning("Student Database","Duplicate Entry",parent=AddmissionPanel)
                    else:
                        conn.commit()
                        showData()
                        conn.close()
                        messagebox.showinfo("Successful","Data Inserted",parent=AddmissionPanel)
    ...
    UpdationST=Button(Option,text="Updation",font=("Arial",15,"bold"),bg="blue",fg="white",bd=5,width=18,state=DISABLED,cursor="hand2",command=updatePanel)
    ...
    Exit=Button(Option,text="Exit",font=("Arial",15,"bold"),bg="blue",fg="white",bd=5,width=18,command=ExitAdmin,cursor="hand2")
    ...
    OutputFrame.place(x=300,y=100,width=1000,height=640)
